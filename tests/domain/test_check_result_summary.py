...
@pytest.mark.parametrize('statuses,covered,health,state', [([],0,None,'UNKNOWN'), (['UNKNOWN'],1,None,'UNKNOWN'), (['ERROR'],1,None,'UNKNOWN'), (['PASS'],1,100,'READY')])
def test_summary_counts_actual_results_not_planned_scope(statuses, covered, health, state):
