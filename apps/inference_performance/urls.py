...
urlpatterns = [
    ...
    path("inference-performance/engines", api.engines, name="inference-performance-engines"),
    path("inference-performance/engines/", api.engines, name="inference-performance-engines-slash"),
